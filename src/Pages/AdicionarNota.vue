    ...
    <div class="card">
      <div class="card-body p-5" style="width: 60vw !important">
        <div class="row justify-content-center">
          <p class="main pt-5 mb-5">{{funcionario}}</p>
        </div>

        <div class="row mt-5 mb-5 justify-content-center">
            <label for="funcionarioNotas">Adicione notas para o funcionário</label>
          <textarea name="funcionarioNotas" id cols="90" rows="10"></textarea>
        </div>
...
export default {
  ...
  methods: {
    adicionar() {
      this.$toast.success("Nota adicionada", "Sucesso", {
        position: "topRight"
      });
